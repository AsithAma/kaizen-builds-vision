    ...
    <section id="about" className="py-20 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-zinc-900 rounded-2xl p-8 hover:shadow-xl transition-shadow duration-300">
          ...
          <div className="bg-[#54a9f2] rounded-2xl p-8 text-black hover:shadow-xl transition-shadow duration-300">
